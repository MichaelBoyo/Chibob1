...
public class BikeTest {
    ...
    public void accelerateGear1Test() {
        ...
        kawa.accelerate(true);                      // when I accelerate and my speed is between 0 and 20
//        kawa.accelerate(true);
//        kawa.accelerate(true);
       // assertEquals(1, kawa.getGearNumber());  // assert that the bike enters gear 1
        assertEquals(1, kawa.getSpeed());  // assert that my speed changes by 1 point
    }
